...
CREATE INDEX idx_brokers_order ON brokers("order");
...
CREATE INDEX idx_cashback_date ON cashback_transactions(date);
CREATE INDEX idx_cashback_referral ON cashback_transactions(referral_bonus_to);
